...
class EmailListMapperTest {
    ...
    private companion object {
        ...
        @JvmStatic
        fun provideDataForMapper(): Stream<Arguments> =
            Stream.of(
        ...
        private fun testDataToCheckTheSorting(): Arguments =
            Arguments.of(
                listOf(
                    getEmailListItemDto(
                        id = TEST_ID,
        ...
        private fun testDataWithValidInput() =
            Arguments.of(
                listOf(
                    getEmailListItemDto(
                        id = TEST_ID,
        ...
        private fun testDataWithNullPayloadFrom() =
            Arguments.of(
