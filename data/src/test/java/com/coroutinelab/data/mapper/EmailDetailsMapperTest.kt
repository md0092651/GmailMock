...
class EmailDetailsMapperTest {
    ...
    private fun provideDataForMapper(): Stream<Arguments> =
        Stream.of(
    ...
    private fun testDataToCheckTheFileInfoValue() =
        Arguments.of(
            listOf(
                EmailDetailsDto(
                    id = "id",
    ...
    private fun testDataToCheckTheDefaultFileInfoValue() =
        Arguments.of(
            listOf(
                EmailDetailsDto(
                    id = "id",
    ...
    private fun testDataToCheckTheEmptyValue() =
        Arguments.of(
            listOf(
                EmailDetailsDto(
                    id = "id",
    ...
    private fun testDataToCheckTheEmptyHtmlValue() =
        Arguments.of(
            listOf(
                EmailDetailsDto(
                    id = "id",
    ...
    private fun testDataToCheckTheDefaultValue() =
        Arguments.of(
            listOf(
                EmailDetailsDto(
                    id = "id",
